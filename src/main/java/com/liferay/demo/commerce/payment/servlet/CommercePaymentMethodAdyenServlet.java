...
package com.liferay.demo.commerce.payment.servlet;

import com.liferay.commerce.model.CommerceOrder;
import com.liferay.commerce.payment.engine.CommercePaymentEngine;
import com.liferay.demo.commerce.payment.constants.AdyenCommercePaymentMethodConstants;
...
@Component(
	immediate = true,
	property = {
		"osgi.http.whiteboard.context.path=/" + AdyenCommercePaymentMethodConstants.SERVLET_PATH,
		...
		"osgi.http.whiteboard.servlet.pattern=/" + AdyenCommercePaymentMethodConstants.SERVLET_PATH + "/*"
	},
	service = Servlet.class
)
public class CommercePaymentMethodAdyenServlet extends HttpServlet {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommercePaymentMethodAdyenServlet.class);
